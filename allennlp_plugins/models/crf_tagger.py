...
from allennlp_plugins.modules.conditional_random_field import MyConditionalRandomField
...
class MyCrfTagger(Model):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.crf = MyConditionalRandomField(
    ...
    def forward(
        ...
        **kwargs,
        ...
        # shape [batchsize, seqlen, num_tags]
